  ...
  <div class="book-List">
    <dl v-for="items in bookList.data">
      ...
      <dd v-for="list in items.data" :key="list.id">
        ...
        <span class="info">余额宝-2020.1.2-收益</span>
    ...
    this.list = {
      ...
      data: [
        ...
        },
        {
          id: 2,
          name: "余额宝",
          time: "2020-2-30 13:22:20",
          money: 7546.81,
          iconNum: 2
        }
      ]
    };
    this.bookList = this.recombination(this.list);
    this.classMap = [
      "fushi",
      "yundong",
      "13",
